  ...
  return (
    <div className="min-h-full bg-black flex flex-col">
      ...
      <header className="flex items-center gap-3 px-4 pt-14 pb-3">
        <button
          onClick={onBack}
          className="w-9 h-9 flex items-center justify-center rounded-full bg-zinc-800 text-zinc-400 active:bg-zinc-700 transition-colors"
        >
        ...
        <div className="flex-1 flex items-center gap-2">
          ...
          />
          <h1 className="text-xl font-bold text-white truncate">{folder.name}</h1>
        </div>
        ...
        <button
          ...
          className="w-9 h-9 flex items-center justify-center rounded-full text-white active:opacity-80 transition-colors"
          style={{ backgroundColor: folder.color }}
        >
      ...
      <ChatInput onSubmit={handleChatSubmit} accentColor={folder.color} />
