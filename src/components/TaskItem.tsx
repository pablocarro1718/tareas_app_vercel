...
export function TaskItem({ task, onToggleComplete, onArchive, onClick, onDelete, folderColor }: TaskItemProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-lg">
      ...
      {/* Task card */}
      <div
        className="relative flex items-center gap-3 px-4 py-3 rounded-lg select-none border"
        style={{
          backgroundColor: folderColor ? `${folderColor}0D` : '#1c1c1e',
          borderColor: folderColor ? `${folderColor}1A` : '#27272a',
      ...
      >
        ...
        <button
          ...
          style={{
            borderColor: task.isCompleted || justCompleted ? '#22c55e' : '#52525b',
        ...
        <span
          ...
          style={{
            color: task.isCompleted ? '#52525b' : '#ffffff',
        ...
        >
          ...
          {(task.isCompleted || justCompleted) && (
            <span
              className="absolute left-0 top-1/2 h-[1.5px] bg-zinc-600"
              style={{
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-6">
          ...
          >
            ...
            <p className="text-sm text-zinc-400 text-center truncate px-2">
              {task.text}
            </p>
